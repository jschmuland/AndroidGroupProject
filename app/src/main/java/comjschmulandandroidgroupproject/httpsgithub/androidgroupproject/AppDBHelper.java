...
public class AppDBHelper extends SQLiteOpenHelper {
    ...
    public final static String EXERCISE_QUERY = String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY, %s DATETIME, %s INTEGER);", EXERCISE_TABLE, KEY_ID, DATE, EXERCISE_NAME, CALORIES, EXERCISE_DURATION);
